...
router.get('/me', requireAuth, async (req, res) => {
  ...
  const currentTier = vipTiers.find(t => totalSpent >= t.minSpent) || null;
  const nextTier = vipTiers.slice().sort((a, b) => a.minSpent - b.minSpent).find(t => totalSpent < t.minSpent) || null;
